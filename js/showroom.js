AFRAME.registerComponent("showroom", {
    schema: {
      state: { type: "string", default: "car-list" },
    ...
    tick: function() {
      const { state } = this.el.getAttribute("showroom");
      ...
      const thumbNailsRef = [
        {
          id: "ferrariF50",
          title: "Ferrari F50 ",
          url: "./assets/cars/ferrari_f50_1995/ferrari.png"
        },
        {
          id: "mclspd",
          title: "Mclaren Spider",
          url: "./assets/cars/mclaren_spider/mclaren.jpg"
        },
  
        {
          id: "pagani",
          title: "Pagani Zonda Cinque",
          url: "./assets/cars/pagani_zonda_cinque/pagani.jpg"
        },
        {
          id: "porche",
          title: "Porche 718 Cayman gt",
          url: "./assets/cars/porche_718_cayman_gt4_unrigged/porche.jpg"
        }
      ];
